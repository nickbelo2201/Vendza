...
const ROUTE_META: Record<string, { secao: string; titulo: string }> = {
  ...
  "/catalogo/produtos": { secao: "Operação", titulo: "Produtos" },
  "/catalogo/categorias": { secao: "Operação", titulo: "Categorias" },
  "/catalogo/subcategorias": { secao: "Operação", titulo: "Subcategorias" },
  "/catalogo/combos": { secao: "Operação", titulo: "Combos" },
  "/catalogo/grupos-de-complementos": { secao: "Operação", titulo: "Grupos de Complementos" },
  "/catalogo/complementos": { secao: "Operação", titulo: "Complementos" },
  "/catalogo/extras": { secao: "Operação", titulo: "Extras" },
